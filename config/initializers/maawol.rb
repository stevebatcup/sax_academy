Maawol.configure do |config|
	config.site_name = "Sax Academy"
	config.site_slug = "sax_academy"
	config.site_host = Rails.application.credentials.host

	config.site_owner_fname = "Jane"
	config.site_owner_lname = "Jones"
	config.site_owner_email = "jane.jones@maawol.com"
